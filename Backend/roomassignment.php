						...
						<div class="dashboard_graph">
							...
							<div class="col-md-7">
								<div class="panel panel-default">
								 <div class="panel-heading">Assign New Tenant</div>
								 <table class="table table-hover">
									 <tbody><tr>
										<th>Name <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></th>
										<th>Prefered Room <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></th>
										<th>Move-in Date <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></th>
										<th>Room</th>
										<th></th>
									 </tr>
									 <tr>
										<td>Yra Bacalanmo</td>
										<td>4 occupancy Room exterior window</td>
										<td>April 2016</td>
										<td> <select class="form-control" id="room">
													<option>101A</option>
													<option>101B</option>
													<option>101C</option>
											</select></td>
										<td><button type="button" class="btn btn-primary"> Occupy</button></td>
									 </tr>
								 </tbody></table>
							</div>
							</div>
							...
							<div class="panel panel-default">
								 ...
								 <table class="table table-hover">
									 <tbody><tr>
										<th>Room No. <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></th>
										<th>Number of Occupants <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></th>
										<th>Space Available <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></th>
									 </tr>
									 <tr>
										<td>101A</td>
										<td>2</td>
