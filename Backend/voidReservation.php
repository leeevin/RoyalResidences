<?php
	...
	try {
				...
				if($sqlCheck->rowCount() == 1) {
					$sqlUpdate = "INSERT INTO archive_reservation SELECT * FROM reservation WHERE reservationCode = '$reservationCode'; DELETE FROM reservation WHERE reservationCode = '$reservationCode'";
