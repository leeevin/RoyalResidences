		...
		<div class="main_container">
			...
			<div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
									...
									<tr>
										<td>2/5/2016</td>
										<td><a href="accounts.html">Yra Bacalanmo</a></td>
                                ...
                                <div class="text-right">
                                    <a href="vanotif.html">View All Notifications <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
            </div>
			</div>
			...
			<div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <a href="vareserve.html">View All Reservations <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
             </div>	
			...
			<div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <a href="vapay.html">View All Payment Details <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
             </div>	
			</div>	
