        ...
        <div class ="row" >
            <div class="col-lg-12">
                ...
                <div class="row">
					...
					<form method = "POST" action = "checkRelationship.php">
                        <div class ="row">
                            <div class="col-md-7">
                                <div class="control-group form-group">
                                 <?php
								 for($x = 1; $x <= $_SESSION['numberOfPersons']; $x++) {
								 ...
								 ?>   
									<div class="controls">
                                        ...
                                        <label class="radio-inline">
                                          <input type="radio" name="gender<?php echo $x;?>" id="inlineRadio1" value="male"> Male
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="gender<?php echo $x;?>" id="inlineRadio1" value="female"> Female
                                        </label>
                                     </div>
								...
								?>	
								<?php
								 for($y = 1; $y <= $_SESSION['numberOfPersons']; $y++) {
	
								 ?>
                                <div class="control-group form-group">
                                    <div class="controls">
                                        <label>Relationship with person <?php echo $y;?></label>
                                        <p class="help-block"></p>
                                        <label class="radio-inline">
                                          <input type="text" name="relationshipWithPerson<?php echo $y;?>" id="inlineRadio1" required>
                                        </label>
                                    </div>
                                </div>    
								<?php
								...
								<div class="controls">
                                        ...
                                        <p class="help-block"></p>
                                        <label class="radio-inline">
                                          <input type="radio" name="room_occupancy" id="inlineRadio1" value="same_room"> Same Room
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="room_occupancy" id="inlineRadio1" value="separate_room"> Separate Room
                                        </label>
                                   </div>
                                </div>  
                            </div>
