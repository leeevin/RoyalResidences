            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="progress" id="progress1" style="margin-top: 20px; margin-bottom: 0px;">
                        <div class="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 12.5%;">                
                        </div>
                        <span class="progress-type">Room Reservation</span>
                        <span class="progress-completed">Step 1 of 8</span>
                    </div>      
                </div>
                    <div class ="row" >
					...
					<form action = "errorPage.php" method = "post">
                        <div class ="row">
                            <div class="col-md-7">
                                <div class="control-group form-group">
                                    <div class="controls">
                                        <h4>Number of persons to reserve</h4>
                                        <p class="help-block"></p>
										<div class="col-md-3">
                                          <input type="text" class="form-control" name="numberOfPersons" id="inlineRadio1">  
										 </div>
                                    </div>
                                </div>
                        ...
                        <hr>
                            <div class = "pageButton">
                                <ul class = "pager">
									<li><button type="submit" name="submitnumpers" class="btn btn-default">Next</button></li>
								</ul>
                            </div>
						</form>
                    </div>
