...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
                ...
                <h1 class="page-header">Gallery
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="container">
													...
													<div class ="container-fluid">
                                                        <header id="carousel-bounding-box">
                                                            <div class="carousel slide" id="myCarousel" class ="container">
                                                                <!-- Carousel items -->
                                                                <div class="carousel-inner">
                                                                    <div class="active item" data-slide-number="0">
                                                                        <img class="img-responsive" src="images/1.JPG"></div>

                                                                    <div class="item" data-slide-number="1">
                                                                        <img class="img-responsive" src="images/2.JPG"></div>

                                                                    <div class="item" data-slide-number="2">
                                                                        <img class="img-responsive" src="images/3.JPG"></div>

                                                                    <div class="item" data-slide-number="3">
                                                                        <img class="img-responsive" src="images/4.JPG"></div>

                                                                    <div class="item" data-slide-number="4">
                                                                        <img class="img-responsive" src="images/5.JPG"></div>

                                                                    <div class="item" data-slide-number="5">
                                                                        <img class="img-responsive" src="images/6.JPG"></div>

                                                                    <div class="item" data-slide-number="6">
                                                                        <img class="img-responsive" src="images/7.JPG"></div>

                                                                    <div class="item" data-slide-number="7">
                                                                        <img class="img-responsive" src="images/8.jpg"></div>

                                                                    <div class="item" data-slide-number="8">
                                                                        <img class="img-responsive" src="images/9.jpg"></div>

                                                                    <div class="item" data-slide-number="9">
                                                                        <img class="img-responsive" src="images/10.jpg"></div>

                                                                    <div class="item" data-slide-number="10">
                                                                        <img class="img-responsive" src="images/11.jpg"></div>

                                                                    <div class="item" data-slide-number="11">
                                                                        <img class="img-responsive" src="images/12.jpg"></div>

                                                                    <div class="item" data-slide-number="12">
                                                                        <img class="img-responsive" src="images/13.jpg"></div>

                                                                    <div class="item" data-slide-number="13">
                                                                        <img class="img-responsive" src="images/14.jpg"></div>

                                                                    <div class="item" data-slide-number="14">
                                                                        <img class="img-responsive" src="images/15.JPG"></div>
																		
																	<div class="item" data-slide-number="15">
                                                                        <img class="img-responsive" src="images/16.JPG"></div>
																		
																	<div class="item" data-slide-number="16">
                                                                        <img class="img-responsive" src="images/17.JPG"></div>
																		
																	<div class="item" data-slide-number="17">
                                                                        <img class="img-responsive" src="images/18.JPG"></div>
																		
																	<div class="item" data-slide-number="18">
                                                                        <img class="img-responsive" src="images/19.JPG"></div>
																		
																	<div class="item" data-slide-number="19">
                                                                        <img class="img-responsive" src="images/20.JPG"></div>
																		
																	<div class="item" data-slide-number="20">
                                                                        <img class="img-responsive" src="images/21.JPG"></div>
																		
																	<div class="item" data-slide-number="21">
                                                                        <img class="img-responsive" src="images/22.JPG"></div>
                                            ...
                                            <div class="col-lg-9" id="slider-thumbs">
                                                <ul class="hide-bullets">
													...
													<li class="col-md-1">
                                                        <a class="thumbnail" id="carousel-selector-19"><img class="img-responsive" src="images/20.jpg"></a>
                                                    </li>
													
													<li class="col-md-1">
                                                        <a class="thumbnail" id="carousel-selector-20"><img class="img-responsive" src="images/21.jpg"></a>
                                                    </li>
													
													<li class="col-md-1">
                                                        <a class="thumbnail" id="carousel-selector-21"><img class="img-responsive" src="images/22.jpg"></a>
                                                    </li>
    ...
    function resetActive(event, percent) {
        ...
        if (event.target.className == "col-md-1") {
