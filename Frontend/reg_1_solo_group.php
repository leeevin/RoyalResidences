                        ...
                        <div class ="row">
                            <div class="col-md-7">
                                <div class="control-group form-group">
									...
									<div class="controls">
										<p>
											<label>Select the type of reservation you want:</label>
											<p class="help-block"></p>
											<label class="radio-inline">
											  <input type="radio" name="type_of_reservation" id="inlineRadio1" value="solo"> Solo reservation
											</label>
											<label class="radio-inline">
											  <input type="radio" name="type_of_reservation" id="inlineRadio1" value="group"> Group Reservation
											</label>
										</p>
                                    </div>
